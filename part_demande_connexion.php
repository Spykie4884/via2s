...
{
	//Détéction d'erreur (cas normalement impossible).
	echo 'Vous êtes déjà connecté - Veuillez envoyez le message suivant au pôle R&D: part_demande_connexion.php / Cas impossible';
}
else
{
