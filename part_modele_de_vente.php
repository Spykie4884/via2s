...
<div id="content">
	<div id="content_item">
		...
		<br />
		<br />
		<h1>La Solution VIA2S</h1>
		<br/>
		<p>
			<span class="strong_via2s">VIA2S</span> a élaboré une stratégie qui s'appuie sur un modèle de vente qui pérennise les solutions et produits installés chez les clients, en leur laissant le choix du profil du prestataire, intégrateur ou installateur,
			agréé par <span class="strong_via2s">VIA2S</span> dans le cadre d'un contrat de partenariat.<BR><br>
		</p>
