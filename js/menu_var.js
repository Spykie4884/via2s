...
***********************************************************************************/
	...
	var TailleCase=128;				// taille des cases du menu
...
Menu3=new Array("Services","","",5,20,TailleCase);
	...
	Menu3_2=new Array("Centre de formation","","",3,40,TailleCase);
...
Menu6=new Array("Emplois","","",2,20,TailleCase);
	Menu6_1=new Array("Postes à pourvoir",Racine+"/emplois/postes_a_pourvoir.php","",0,20,TailleCase);
	Menu6_2=new Array("Stages",Racine+"/emplois/stages.php","",0,20,TailleCase);
