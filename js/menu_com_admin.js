...
*************************************************************************************/
	...
	var LowBgColor='#0863CE';			// Background color when mouse is not over
	var LowSubBgColor='#0863CE';			// Background color when mouse is not over on subs
	...
	var Arrws=['',5,10,'img/tridown.gif',10,5,'',5,10];	// Arrow source, width and height
	...
	var Exp6 = (AppVer.indexOf("msie 6") !=-1)?1:0
	var position = (Exp6 == 1)?"absolute":"fixed"
	var StartTop= (Exp6 != 1)?50:100				// Menu offset x coordinate
...
function OpenMenu(){	
	...
	HiliteItem(HP);
	this.ChildCntnr.style.display = 'inline';
	if(CCnt!=null){
...
function CntnrSetUp(Wdth,Hght,NoOff){
	...
	if(x)this.bgColor=x;
	if(Nav4){	this.visibility='hide'; this.display ='none';
...
function CreateMenuStructure(MName,NumberOf){
	...
	if(DomYes){
		...
		MmbrCntnr.style.position=position;
	...
	for(i=1;i<NumberOf+1;i++){
		...
		if(NoOffSubs) {
			...
			Mbr.ChildCntnr.style.display = 'none';
		}
		PrvMmbr=Mbr}
